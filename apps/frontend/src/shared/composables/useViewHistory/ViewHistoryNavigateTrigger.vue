<template>
    <Button variant="ghost" :disabled="!canBack(contextId).value" class="size-7" @click="syncBack(contextId)">
        <slot name="back" />
    </Button>
    <Button variant="ghost" :disabled="!canForward(contextId).value" class="size-7" @click="syncForward(contextId)">
        <slot name="forward" />
    </Button>
</template>
