...
onMounted(() => {
    console.log('Component <WorkbenchOverview> mounted');
});

onUnmounted(() => {
    console.log('Component <WorkbenchOverview> unmounted');
});

onActivated(() => {
    console.log('Component <WorkbenchOverview> activated');
...
onDeactivated(() => {
    console.log('Component <WorkbenchOverview> deactivated');
    console.log('activeTabId:', activeTabId.value);
    const entry = getEntity(activeTabId);
    console.log('entry:', entry.value);
});
