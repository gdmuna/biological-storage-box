...
@Injectable()
export class MultipartRequestHandlerFactory {
...
export class MultipartRequestHandler<T extends HandlerState = HandlerState> {
    private constructor(
        ...
        private readonly factory: MultipartRequestHandlerFactory
    ) {}
    ...
    private static create<T extends HandlerState>(
        state: T,
        factory: MultipartRequestHandlerFactory
    ) {
        return new MultipartRequestHandler(state, factory);
    }
    ...
    static async init(
        ...
        if (resolveType === 'stream') {
            ...
            return MultipartRequestHandler.create({ type: 'stream' as const, data }, factory);
            ...
            return MultipartRequestHandler.create({ type: 'buffer' as const, data }, factory);
            ...
            return MultipartRequestHandler.create({ type: 'file' as const, data }, factory);
        }
