...
describe('org-user API module', () => {
    ...
    describe('applyJoinOrg', () => {
        it('calls Post /org/user/apply with orgId', () => {
            applyJoinOrg('org-1');
            expect(alovaInstance.Post).toHaveBeenCalledWith('/org/user/apply', { orgId: 'org-1' });
        });
    });
    ...
    describe('acceptApply', () => {
        it('calls Post /org/user/apply/ac with orgId and userId', () => {
            ...
            expect(alovaInstance.Post).toHaveBeenCalledWith('/org/user/apply/ac', {
                orgId: 'org-1',
                userId: 'user-2',
            });
        });
    ...
    describe('rejectApply', () => {
        it('calls Post /org/user/apply/ms with orgId and userId', () => {
            ...
            expect(alovaInstance.Post).toHaveBeenCalledWith('/org/user/apply/ms', {
                orgId: 'org-1',
                userId: 'user-2',
            });
        });
    ...
    describe('inviteUser', () => {
        it('calls Post /org/user/invite with orgId and userId', () => {
            ...
            expect(alovaInstance.Post).toHaveBeenCalledWith('/org/user/invite', {
                orgId: 'org-1',
                userId: 'user-5',
            });
        });
    ...
    describe('acceptInvite', () => {
        it('calls Post /org/user/invite/ac with orgId', () => {
            acceptInvite('org-1');
            expect(alovaInstance.Post).toHaveBeenCalledWith('/org/user/invite/ac', {
                orgId: 'org-1',
            });
        });
    });
    ...
    describe('rejectInvite', () => {
        it('calls Post /org/user/invite/ms with orgId', () => {
            rejectInvite('org-1');
            expect(alovaInstance.Post).toHaveBeenCalledWith('/org/user/invite/ms', {
                orgId: 'org-1',
            });
        });
    });
    ...
    describe('listPendingOrgUsers', () => {
        it('calls Get /org/user/list with orgId param', () => {
            ...
            expect(alovaInstance.Get).toHaveBeenCalledWith('/org/user/list', {
                params: { orgId: 'org-1' },
            });
        });
    });
    ...
    describe('listOrgMembers', () => {
        it('calls Get /org/user/member/list with orgId param', () => {
            ...
            expect(alovaInstance.Get).toHaveBeenCalledWith('/org/user/member/list', {
                params: { orgId: 'org-1' },
            });
        });
    });
    ...
    describe('updateMemberAuthority', () => {
        it('calls Put /org/user/updateAuthority with ADMIN role', () => {
            ...
            expect(alovaInstance.Put).toHaveBeenCalledWith('/org/user/updateAuthority', {
                orgId: 'org-1',
                userId: 'user-2',
                role: 'ADMIN',
            });
